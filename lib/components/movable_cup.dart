...
class MovableCup  {
  ...
  MovableCup(Function refresh, Size size, double iconWidth, String image, String pos){
    ...
    if(pos=="topLeft"){
      ...
      left=(size.width/2-iconWidth/2-kDefaultPadding); top=0;
      index=1;
    }
    ...
    if(pos=="bottomLeft"){
      ...
      left=(size.width/2-iconWidth/2-kDefaultPadding); bottom=0;
      index=4;
    }
    ...
    positioned=AnimatedPositioned(duration: Duration(seconds: 1),
        ...
        child:    GestureDetector(onTap: (){refresh(index);}, child: Image.asset("assets/images/pngsmall/"+image, width:iconWidth  )));
